...
class EvalHook(_EvalHook):
    ...
    def _do_evaluate(self, runner):
        ...
        import importlib
        gpu_test_name = runner.model.module.backbone.__class__.__name__.lower()
        try:
...
class DistEvalHook(_DistEvalHook):
    ...
    def _do_evaluate(self, runner):
        ...
        gpu_test_name = runner.model.module.backbone.__class__.__name__.lower()
        try:
            multi_gpu_test = getattr(
                importlib.import_module('mmseg.apis'), 'multi_gpu_test_' + gpu_test_name)
        except AttributeError:
            multi_gpu_test = getattr(
                importlib.import_module('mmseg.apis'), 'multi_gpu_test')
